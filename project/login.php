            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <input type="submit" name="submit" value="เข้าสู่ะบบ" class="w-full mb-2 bg-rose-500 hover:bg-rose-400 text-white font-bold py-2 px-4 border-b-4 border-rose-700 hover:border-rose-500 roundedbg-rose-500 hover:bg-rose-400 text-white font-bold py-2 px-4 border-b-4 border-rose-700 hover:border-rose-500 rounded"></a>
                        <p class="text-center mb-0">คุณยังไม่มีบัญชีใช่หรือไม่? <a class="text-red-500" href="register.php">สมัครสมาชิก</a></p>
                        <?php
