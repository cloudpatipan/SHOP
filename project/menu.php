...
<body>
  ...
  <nav class="p-5 shadow md:flex md:items-center md:justify-center bg-black relative sticky w-full mb-4 ">
    ...
    <button class="bg-rose-500 hover:bg-rose-400 text-white font-bold border-b-4 border-rose-700 hover:border-rose-500 roundedbg-rose-500 hover:bg-rose-400 text-white font-bold px-4 border-b-4 border-rose-700 hover:border-rose-500 rounded-full ml-2" type="submit">ค้นหา</button>
     </form>
     <div class="ml-20">
     <b></b><?php echo $_SESSION["firstname"] . " " . $_SESSION["lastname"] ; ?></b><br>
     <a href="logout.php" class="bg-rose-500 hover:bg-rose-400 text-white font-bold border-b-4 border-rose-700 hover:border-rose-500 roundedbg-rose-500 hover:bg-rose-400 text-white font-bold px-4 border-b-4 border-rose-700 hover:border-rose-500 rounded-full ml-2">ออจากระบบ</a>
     </div>
  </nav>
