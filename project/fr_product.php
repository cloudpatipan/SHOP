        ...
        <div class="text-center text-3xl rounded-lg text-white font-bold mb-6">
            เพิ่มข้อมูลสินค้า
                ...
                <form name="form1" method="post" action="insert_product.php" enctype="multipart/form-data">
                    ...
                    <div class="pt-4">
                    <button type="submit" class="inline-block px-6 py-2 border-2 border-green-500 text-green-500 font-medium text-3xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">ยืนยัน</button>
