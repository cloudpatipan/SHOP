      ...
      <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <?php
                             $sql = "SELECT * FROM member WHERE member.id";
                             $hand = mysqli_query($conn,$sql);
                             $row=mysqli_fetch_array( $hand );

                             ?>

                        <img class="rounded-circle" src="img/<?=$row['image']?>" alt="" style="width: 40px; height: 40px;">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <img class="rounded-circle me-lg-2" src="img/<?=$row['image']?>" style="width: 40px; height: 40px;">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="logout.php" class="dropdown-item">ออจากระบบ</a>
                        </div>
                    </div>
                </div>
            </nav>