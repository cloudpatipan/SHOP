...
<div class="col-sm-1">
<button type="submit" class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">ค้นหา</button>
</div>
</div>
</form>
</div>
...
?>
                                <tr>
                                    ...
                                    <td class="py-3"><a href="report_order_detail.php?id=<?=$row['orderID']?>" class="bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded"
                                    return false;>รายละเอียด</a></td>

                                    <td class="py-3"><a href="pay_order.php?id=<?=$row['orderID']?>" class="bg-yellow-500 hover:bg-yellow-400 text-white font-bold py-2 px-4 border-b-4 border-yellow-700 hover:border-yellow-500 rounded"
...
<script>
    function del1(mypage1){ 
        var agree=confirm('คุณต้องการปรับสถานะหรือไม่');
        if(agree){
